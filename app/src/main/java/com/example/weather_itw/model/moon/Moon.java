package com.example.weather_itw.model.moon;
...
public class Moon {
    ...
    public String get_MoonRise_Time(){
        return this.getRecords().getLocations().getLocation().get(0)
                .getTime().get(0).getParameter().get(0).getParameterValue();
    }
    public String get_MoonSet_Time(){
        return this.getRecords().getLocations().getLocation().get(0)
                .getTime().get(0).getParameter().get(4).getParameterValue();
    }
}
